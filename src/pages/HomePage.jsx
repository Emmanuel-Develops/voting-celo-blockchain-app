...
const HomePage = () => {
    ...
    const clickScroll = (e) => {
        ...
        // console.log(homePage.current.scrollHeight)
        // console.log(window.pageYOffset)
        scrollUp ? navHeading.current.scrollIntoView(true)
            : voteNow.current.scrollIntoView(true)
    }
    ...
    useEffect(() => {
        ...
        function testing() {
            setTimeout (() => {
                ...
                if (window.scrollY / scrollHeight > 0.5) {
                    setScrollUp(true)
                } else {
                    setScrollUp(false)
                }
    ...
    return (
        <div className="w-100">
            ...
            <header ref={navHeading} className="fixed h-20 w-full z-10 bg-black bg-opacity-80 header-nav">
            ...
            <main className="pt-20 w-full bg-black outline-white bg-opacity-40">
                <div className="splash-screen flex items-center justify-center outline-white">
                    ...
                    <div ref={handRef} onClick={(e) => clickScroll(e)} style={{ transform: `rotate(${-180}deg)` }} className="absolute filter cursor-pointer lg:fixed w-12 md:w-24 top-1/2 right-10 saturate-0 hover:saturate-100">
                        <img src={hand} className="w-full filter drop-shadow-lg bouncy-hand" alt="illustration click to scroll" />
                    </div>
                </div>
                <div className="min-h-screen">
                    <div className=" bg-white my-30 block-text mt-40">
