        ...
        <div ref={splashScreen} className="pt-20 min-h-screen flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8 md:gap-2 md:w-10/12 max-w-7xl py-8 px-4 md:px-0 mx-auto">
            <div className="intro  md:col-span-2">
              <span className="inline-block font-black my-2 px-3 py-1 text-3xl md:text-5xl lg:text-6xl rounded-xl transparent-text">
                VETO
              </span>
          ...
          <div
            ref={handRef}
            onClick={(e) => clickScroll(e)}
            style={{ transform: `rotate(${deg}deg)` }}
            className="hand-wrapper absolute cursor-pointer lg:fixed w-12 md:w-20 top-1/2 right-10"
          >
            <img
              src={hand}
              className="w-full filter drop-shadow-lg saturate-0 bouncy-hand transition-all"
              alt="illustration click to scroll"
            />
          </div>
        </div>
        <div className="min-h-screen grid place-items-center bg-white py-20 px-0">
          <div className="grid grid-cols-1 gap-y-8 md:grid-cols-6 md:gap-x-10 md:gap-y-0 md:w-10/12 max-w-7xl py-8 mx-auto">
            ...
            <div className="col-span-4">
              ...
              <p className="font-genos text-black-300 text-lg md:text-2xl pt-5">
                veto is a personal project to help solidify my knowledge on creating smart
                contracts.
              </p>
            </div>
            ...
            <div className="col-span-4">
              ...
              <p className="font-genos text-black-300 text-lg md:text-2xl pt-5">
                ...
                The next requirement is a desktop device. You'll need a chrome browser on a desktop
                to connect to your celo wallet through the extension, and with that the wallet can
                interact with veto.
              </p>
            </div>
